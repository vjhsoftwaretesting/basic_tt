...
public class API {
	...
	@Test
	public void APIPage() throws InterruptedException {
		...
		WebElement APIButton = driver.findElement(By.xpath("//*[@title='API']"));
		APIButton.click();
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_btnAPISave']")));
