...
public class AppsAndDownloads {
	
	
	@Test
	public void AppsAndDownloadsPage() throws InterruptedException {
		...
		WebElement AppsAndDownloadsButton = driver.findElement(By.xpath("//*[@title='Apps & Downloads']"));
		AppsAndDownloadsButton.click();
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='inner-container']")));
