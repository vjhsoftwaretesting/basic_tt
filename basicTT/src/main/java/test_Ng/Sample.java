...
public void timeEntry_approve_perbill () throws InterruptedException {
	...
	clientsearchBox.sendKeys("Hammer Mission");
	...
	Thread.sleep(1000);
	    ...
	    for (int i = 0; i <= allOptions.size(); i++) {
		    ...
		    if (allOptions.get(i).getText().contains("Jane Froster")) {
		...
		activitySearchBox.sendKeys("Documentation");
		...
		//approve the current entry process
		Thread.sleep(1000);
		...
		WebElement rowCheckBox = driver.findElement(By.xpath("//*[@rowid='0']//child::input"));
		rowCheckBox.click();
		...
		mailAddress.sendKeys("xavier@vjhsoftware.in");
