...
public class TTB_AddProject_ProjectID_Description {
...
WebDriver driver;
	...
	@Test(dataProvider = "clientName")
	   public void AddProject_projectID (String cli_org_Name, String proName, String proID) throws InterruptedException  {
			...
			WebElement customID = driver.findElement(By.id("ctl00_ContentPlaceHolder1_chkEnableCustomID"));
			if(customID.isSelected()) {
				WebElement projectID = driver.findElement(By.id("ctl00_ContentPlaceHolder1_projectIDTextBox_textBoxValue"));
				projectID.sendKeys(proID);
			}
			else {}
			...
			driver.findElement(By.name("ctl00$ContentPlaceHolder1$projectDescriptionTextBox")).click();
			
			Thread.sleep(4000);
			
			WebElement projectDescription = driver.findElement(By.name("ctl00$ContentPlaceHolder1$projectDescriptionTextBox"));
			projectDescription.sendKeys(proID+"-'"+proName+"' is created");
