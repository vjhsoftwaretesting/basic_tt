...
public class TTB_AallPagesLoading {
	WebDriver driver;
	...
	public void MoreMenuPage() throws InterruptedException {
		...
		WebElement serverNo = driver.findElement(By.xpath("//*[@class=\"paddingLeft5 paddingRight5\"]"));
		String servernumber = serverNo.getText();
		System.out.println("All pages loading test has been executed in "+servernumber);
		}
