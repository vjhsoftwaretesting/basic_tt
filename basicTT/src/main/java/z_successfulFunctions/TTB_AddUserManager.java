...
public class TTB_AddUserManager {
WebDriver driver;
	...
	@Test(dataProvider = "userDetails")
	   public void AddUserManager (String fName, String lName, String emailID) throws InterruptedException  {
			...
			Thread.sleep(3000);
			WebElement accessPermissionButton = driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_ctl00']/div/ul/li[2]/a"));
			accessPermissionButton.click();
			
			Thread.sleep(2000);
			WebElement managerButton = driver.findElement(By.id("ctl00_ContentPlaceHolder1_UserType_UserTypeList_1"));
			managerButton.click();
			
			Thread.sleep(3000); 
			WebElement overviewButton = driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_ctl00']/div/ul/li[1]/a"));
