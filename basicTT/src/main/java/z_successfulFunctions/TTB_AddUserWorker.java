...
public class TTB_AddUserWorker {
WebDriver driver;
	...
	@Test(dataProvider = "userDetails")
	   public void AddUserWorker (String fName, String lName, String emailID) throws InterruptedException  {
			...
			Thread.sleep(2000);
			WebElement workerButton = driver.findElement(By.id("ctl00_ContentPlaceHolder1_UserType_UserTypeList_2"));
			workerButton.click();
